...
declare module '$env/static/private' {
	...
	export const IFORT_COMPILER23: string;
	export const INIT_CWD: string;
	export const INSPECTOR_2023_DIR: string;
	export const I_MPI_ONEAPI_ROOT: string;
	...
	export const ONEAPI_ROOT: string;
	...
	export const RABBITMQ_NODENAME: string;
	...
	export const TRNSYS: string;
	export const USERDOMAIN: string;
	export const USERDOMAIN_ROAMINGPROFILE: string;
	export const USERNAME: string;
	export const USERPROFILE: string;
	export const VBOX_MSI_INSTALL_PATH: string;
	export const VS2022INSTALLDIR: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		HOMEDRIVE: string;
		HOMEPATH: string;
		IFORT_COMPILER23: string;
		INIT_CWD: string;
		INSPECTOR_2023_DIR: string;
		I_MPI_ONEAPI_ROOT: string;
		LANG: string;
		LOCALAPPDATA: string;
		LOGONSERVER: string;
